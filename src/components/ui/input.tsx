...
export function Input({
  ...
  const inputClassName = cn(
    "h-9 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3.5)-1px)] leading-9 outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72",
    size === "sm" &&
      "h-8 px-[calc(--spacing(3)-1px)] leading-8",
